...
abstract class RemoteClient {
  ...
  @GET("/activite/list")
  Future<List<BusinessActivity>> getBusinessActivities();
  ...
  @PUT("/contribuable/{id}/localisation")
  Future<Coordinate> updateContribuableLocation(@Body() Coordinate coordinate, @Path("id") int id);
}
